...
final class CountrySeeder extends AbstractSeeder
{
    ...
    public function __construct(Country $model)
    {
        ...
        $this->itemList = [
            ...
            ['iso_alpha_2' => 'BY', 'iso_alpha_3' => 'BLR', 'iso_numeric' => '112', 'name' => 'Belarus', 'currency_id' => $this->getCurrencyId('BYN')],
            ...
            ['iso_alpha_2' => 'CW', 'iso_alpha_3' => 'CUW', 'iso_numeric' => '531', 'name' => 'Curaçao', 'currency_id' => $this->getCurrencyId('XCG')],
            ...
            ['iso_alpha_2' => 'HR', 'iso_alpha_3' => 'HRV', 'iso_numeric' => '191', 'name' => 'Croatia', 'currency_id' => $this->getCurrencyId('EUR')],
            ...
            ['iso_alpha_2' => 'MR', 'iso_alpha_3' => 'MRT', 'iso_numeric' => '478', 'name' => 'Mauritania', 'currency_id' => $this->getCurrencyId('MRU')],
            ...
            ['iso_alpha_2' => 'SL', 'iso_alpha_3' => 'SLE', 'iso_numeric' => '694', 'name' => 'Sierra Leone', 'currency_id' => $this->getCurrencyId('SLE')],
            ...
            ['iso_alpha_2' => 'ST', 'iso_alpha_3' => 'STP', 'iso_numeric' => '678', 'name' => 'São Tomé and Príncipe', 'currency_id' => $this->getCurrencyId('STN')],
            ['iso_alpha_2' => 'SV', 'iso_alpha_3' => 'SLV', 'iso_numeric' => '222', 'name' => 'El Salvador', 'currency_id' => $this->getCurrencyId('SVC')],
            ['iso_alpha_2' => 'SX', 'iso_alpha_3' => 'SXM', 'iso_numeric' => '534', 'name' => 'Sint Maarten', 'currency_id' => $this->getCurrencyId('XCG')],
            ...
            ['iso_alpha_2' => 'VE', 'iso_alpha_3' => 'VEN', 'iso_numeric' => '862', 'name' => 'Venezuela', 'currency_id' => $this->getCurrencyId('VES')],
            ...
            ['iso_alpha_2' => 'ZW', 'iso_alpha_3' => 'ZWE', 'iso_numeric' => '716', 'name' => 'Zimbabwe', 'currency_id' => $this->getCurrencyId('ZWG')],
        ];
    }

    /**
     * Find and set currency_id from the specified ISO code.
     */
