...
/**
 * Handles validation for updating country requests.
 *
 * @since 0.0.0-vertebrae introduced
 */
final class UpdateCountryRequest extends AbstractFormRequest
{
    /**
    ...
    {
        return (bool) $this->user()?->can('update', $this->route('country'));
    }
