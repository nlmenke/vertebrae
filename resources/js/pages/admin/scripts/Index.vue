...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head :title="wTransChoice('scripts.scripts', 2).value" />
        ...
        <div class="w-full p-4">
            ...
            <div class="rounded-md border">
                <Table>
                    <TableHeader>
                        <TableRow>
                            <TableHead>{{ wTrans('scripts.fields.iso_alpha') }}</TableHead>
                            <TableHead>{{ wTrans('scripts.fields.iso_numeric') }}</TableHead>
                            <TableHead>{{ wTrans('scripts.fields.name') }}</TableHead>
                            <TableHead>{{ wTrans('scripts.fields.direction') }}</TableHead>
                            <TableHead></TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
