...
<template>
    <Head :title="wTrans('common.welcome.title').value" />
            ...
            >
                ...
                >
                    <h1 class="mb-1 font-medium">
                        {{ wTrans('common.welcome.get_started') }}
                    </h1>
                    <p
                        class="mb-2 text-[#706f6c] dark:text-[#A1A09A]"
                        v-html="wTrans('common.welcome.get_started_description').value"
                    />
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                {{ wTrans('common.welcome.read_the_docs') }}
                                <a
                                    href="https://laravel.com/docs"
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                >
                                    <span>Laravel {{ wTrans('common.welcome.documentation') }}</span>
                        ...
                        >
                            ...
                            <span>
                                {{ wTrans('common.welcome.watch_tutorials') }}
                                <a
                        ...
                        >
                            ...
                            <span>
                                {{ wTrans('common.welcome.read_the_docs') }}
                                <a
                                    href="https://github.com/nlmenke/vertebrae/tree/main/docs"
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                >
                                    <span>Vertebrae {{ wTrans('common.welcome.documentation') }}</span>
                                    <ExternalLink class="h-2.5 w-2.5" />
                                </a>
                            </span>
                        </li>
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        <li>
                            ...
                            >
                                {{ wTrans('common.welcome.deploy_now') }}
                            </a>
                        </li>
                    </ul>
                </div>
